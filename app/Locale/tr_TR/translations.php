...
return array(
    ...
    'Filename' => 'Dosya adı',
    'Size' => 'Boyutu',
    'Column created successfully.' => 'Sütün başarıyla oluşturuldu.',
    'Another column with the same name exists in the project' => 'Projede aynı isimli başka bir sütün var',
    'Default filters' => 'Varsayılan filtreler',
    'Your board doesn\'t have any columns!' => 'Pano nuzda sütün bulunmuyor!',
    'Change column position' => 'Sütün sıralamasını değiştir',
    ...
    'Close a task when there is no activity in a specific column' => 'Bir sütünda hareket olmadığında bir görevi kapat',
    ...
    'Hide tasks in this column in the dashboard' => 'Panoda bu sütündaki görevleri gizle',
    ...
    'Move the task to another column when closed' => 'Görev kapandığında başka bir sütüna taşı',
    'Move the task to another column when not moved during a given period' => 'Bir sütünda belirli bir süre hareketsiz kalırsa görevi başka bir sütüna taşı',
    ...
    'Add a new column restriction' => 'Sütün kısıtlaması ekle',
    ...
    'Only moving task between those columns is permitted' => 'Sadece belirlenen sütünlar arasında taşıma mümkündür',
    'Close a task in a specific column when not moved during a given period' => 'Bir sütünda belirli bir süre hareketsiz kalan görev kapatılsın',
    'Edit columns' => 'Sütünları güncelle',
    'The column restriction has been created successfully.' => 'Sütün kısıtlaması başarıyla oluşturuldu.',
    'Unable to create this column restriction.' => 'Sütün kısıtlaması oluşturulamadı.',
    'Column restriction removed successfully.' => 'Sütün kısıtlaması başarıyla kaldırıldı.',
    ...
    'You cannot create tasks in this column.' => 'Bu sütünda görev oluşturamazsınız.',
    'Task creation is permitted for this column' => 'Bu sütünda görev oluşturulabilir.',
    'Closing or opening a task is permitted for this column' => 'Bu sütünda görev açma yahut kapatma yapılabilir.',
    'Task creation is blocked for this column' => 'Bu sütünda görev oluşturma bloke edilmiştir.',
    'Closing or opening a task is blocked for this column' => 'Bu sütünda görev açma yahut kapatma bloke edilmiştir.',
    ...
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Bu roldeki kullanıcılar sadece kaynak ve hedef sütünlar arasında görevi hareket ettirebilir.',
    'Remove a column restriction' => 'Sütün kısıtlamasını kaldır',
    'Do you really want to remove this column restriction: "%s" to "%s"?' => 'Sütün kısıtlamasının "%s" den "%s" e değiştireceğinize emin misiniz?',
    'New column restriction for the role "%s"' => '"%s" rolü için yeni sütün kısıtlaması',
    'Rule' => 'Kural',
    'Do you really want to remove this column restriction?' => 'Sütün kısıtlamasını kaldırmak istediğinize emin misiniz?',
    ...
    'Stop the timer of all subtasks when moving a task to another column' => 'Görev başka bir sütüna taşındığında, tüm alt görevlerin zaman sayaçlarını durdur',
    'Subtask Title' => 'Alt Görev Başlığı',
    'Add a subtask and activate the timer when moving a task to another column' => 'Görev başka bir sütüna taşındığında, bir alt görev ekle ve zaman sayacını başlat',
    'days' => 'gün',
    'minutes' => 'dakika',
    'seconds' => 'saniye',
    'Assign automatically a color when preset start date is reached' => 'Başlangıç Tarihi geldiğinde, otomatik olarak bir renk ata',
    'Move the task to another column once a predefined start date is reached' => 'Başlangıç Tarihi geldiğinde, görevi başka bir sütüna taşı',
    ...
    '%s moved the task #%d to the column "%s"' => '%s , #%d görevini "%s" sütünuna taşıdı',
    '%s moved the task #%d to the position %d in the column "%s"' => '%s , #%d görevini "%s" sütünundaki %d pozisyonuna taşıdı',
    ...
    'Move selected tasks to another column or swimlane' => 'Seçili görevleri başka sütüna taşı',
    ...
    'Move the task to another swimlane when the category is changed' => 'Kategorisi değiştiğinde görevi başka bir kulvara taşı',
    'Reorder this column by priority (ASC)' => 'Sütünu artan önceliğe göre sırala',
    'Reorder this column by priority (DESC)' => 'Sütünu azalan önceliğe göre sırala',
    'Reorder this column by assignee and priority (ASC)' => 'Sütünu atanan ve önceliğe göre artan sırala',
    'Reorder this column by assignee and priority (DESC)' => 'Sütünu atanan ve önceliğe göre azalan sırala',
    'Reorder this column by assignee (A-Z)' => 'Sütünu atanana göre artan sırala (A-Z)',
    'Reorder this column by assignee (Z-A)' => 'Sütünu atanana göre azalan sırala (Z-A)',
    'Reorder this column by due date (ASC)' => 'Sütünu hedef tarihe göre artan sırala',
    'Reorder this column by due date (DESC)' => 'Sütünu hedef tarihe göre azalan sırala',
    'Reorder this column by id (ASC)' => 'Sütünu id ye göre artan sırala',
    'Reorder this column by id (DESC)' => 'Sütünu id ye göre azalan sırala',
    ...
    'Move the task to another column when the due date is less than a certain number of days' => 'Hedef tarihe belirli bir gün sayısından az kaldığında görevi başka sütüna taşı',
    'Automatically update the start date when the task is moved away from a specific column' => 'Görev bir sütündan taşındığında başlangıç tarihini otomatik olarak güncelle',
    'HTTP Client:' => 'HTTP İstemci',
    'Assigned' => 'Atanmış',
    'Task limits apply to each swimlane individually' => 'Görev limitini her kulvara ayrı uygula',
    'Column task limits apply to each swimlane individually' => 'Sütün görev limitleri her kulvara ayrı uygulansın',
    'Column task limits are applied to each swimlane individually' => 'Sütün görev limitleri her kulvara ayrı uygulandı',
    'Column task limits are applied across swimlanes' => 'Sütün görev limitleri tüm kulvarlara uygulandı',
    'Task limit: ' => 'Görev limiti',
    ...
    'MXN - Mexican Peso' => 'MXN - Meksika Pezosu',
    'Estimated vs actual time per column' => 'Sütun başına tahmini ve gerçek zaman kıyası',
    'HUF - Hungarian Forint' => 'HUF - Macar Forinti',
    'XBT - Bitcoin' => 'XBT - Bitcoin',
    'You must select a file to upload as your avatar!' => 'Avatar olarak yüklemek için bir dosya seçmelisiniz!',
    'The file you uploaded is not a valid image! (Only *.gif, *.jpg, *.jpeg and *.png are allowed!)' => 'Yüklediğiniz dosya geçerli bir resim dosyası değil! (Sadece *.gif, *.jpg, *.jpeg ve *.png dosyaları izinlidir!)',
    'Automatically set the due date when the task is moved away from a specific column' => 'Görev belirli bir sütündan taşındığında hedef tarihi otomatik olarak ata',
    'No other projects found.' => 'Başka proje bulunamadı.',
    'Please choose a project you want to copy the tasks from.' => 'Görevleri kopyalamak istediğiniz bir proje seçin.',
    'Import Tasks' => 'Görevleri İçeri Aktar',
    'Copy' => 'Kopyala',
    'Tasks copied successfully.' => 'Görevler başarıyla kopyalandı.',
    'Unable to copy tasks.' => 'Görevler kopyalanamadı.',
    'Theme' => 'Tema',
    'Theme:' => 'Tema:',
